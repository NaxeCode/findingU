...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("findingU", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("findingU", null, 640, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "findingU";
		app.meta["name"] = "findingU";
